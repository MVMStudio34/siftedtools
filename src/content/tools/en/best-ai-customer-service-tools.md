...
apps:
  - name: Gorgias
    ...
    description: "Full e-commerce helpdesk with deep native Shopify integration. Billed by ticket volume, built for support teams that scale."
  - name: Tidio
...
faq:
  ...
  - q: "Gorgias vs Tidio: which one should I choose?"
    a: "Tidio when you're early or cost-bound, Gorgias once you have a team and high multichannel ticket volume. The deciding factor is your volume and headcount, not the price. Below a certain volume Gorgias is overkill; above it, Tidio starts to feel like a ceiling."
  - q: "Is Gorgias worth the price for a growing store?"
    a: "If you handle enough tickets that saving an hour a day has real value, yes. Gorgias centralizes email, chat, social and Shopify order data in one place and automates the repetitive work. Under that volume it's oversized, so stay on Tidio until the numbers justify the switch."
  - q: "Can these tools answer customers automatically overnight?"
    a: "Yes, both. Tidio's Lyro answers common questions from your content around the clock; Gorgias's AI Agent can resolve some tickets end to end on its own. Either way the AI covers you outside business hours, which matters when you sell across US and UK time zones."
  - q: "Which AI customer service tool is best for a small Shopify store just starting out?"
    a: "Tidio. You can set it up in an afternoon, there's a free plan to test in real conditions, and Lyro already handles your FAQs. Move to Gorgias later, when ticket volume makes a full helpdesk pay for itself."
